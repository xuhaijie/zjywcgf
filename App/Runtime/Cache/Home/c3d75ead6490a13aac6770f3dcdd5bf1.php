...
<div class="banner">
	...
	<?php default: endswitch;?>
							<div class="right_main">
								<?php if($list): ?><ul class="neiye_news_list">
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li style="height: 140px;">
												<a href="__APP__/news/<?php echo ($vo["id"]); ?>"><img src="__ROOT__/__UPLOAD__/im_<?php echo ($vo["img"]); ?>" onload="AXImg(this,180,220)"/></a>
												<div class="a1">
													<a href="__APP__/news/<?php echo ($vo["id"]); ?>" class="a3"><?php echo ($vo["title"]); ?></a>
												</div>
