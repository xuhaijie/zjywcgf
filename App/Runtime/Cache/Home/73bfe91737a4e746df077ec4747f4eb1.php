	...
	<?php default: endswitch;?>
						...
						<div id="allmap">
							<script>
								...
								var point = new BMap.Point(<?php echo ($config["baidu_map_x"]); ?>, <?php echo ($config["baidu_map_y"]); ?>); // 创建点坐标
		                        ...
		                        var infoWin = new BMap.InfoWindow(
		                        	'<div style="text-align:left;color:#1A6DAF;"><?php $__FOR_START_22563__=1;$__FOR_END_22563__=9;for($i=$__FOR_START_22563__;$i < $__FOR_END_22563__;$i+=1){ switch($i): case "1": ?><p><?php echo ($config['web_name']); ?></p><?php break;?>
		<?php case "2": ?><p>联系人：<?php echo ($config['linkman']); ?></p><?php break;?>
		<?php case "0": ?><p>电话：<?php echo ($config['tel']); ?></p><?php break;?>
		<?php case "3": ?><p>手机：<?php echo ($config['mobile']); ?></p><?php break;?>
		<?php case "0": ?><p>传真：<?php echo ($config['fax']); ?></p><?php break;?>
		<?php case "4": ?><p>地址：<?php echo ($config['address']); ?></p><?php break;?>
		<?php case "0": ?><p>网址：<a href="<?php echo ($config['web_url']); ?>" target="_blank"><?php echo ($config['web_url']); ?></a></p><?php break;?>
		<?php case "0": ?><p>备案：<?php echo ($config['icp_num']); ?></p><?php break;?>
		<?php case "0": ?><p>邮箱：<a href="mailto:<?php echo ($config['email']); ?>"><?php echo ($config['email']); ?></a></p><?php break;?>
		<?php default: endswitch; } ?>
</div>',infoWinOpts);
